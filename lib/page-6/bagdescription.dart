...
class BagDescriptionScreen extends StatefulWidget {
  const BagDescriptionScreen({Key? key}) : super(key: key);
  

  @override
  _BagDescriptionScreenState createState() => _BagDescriptionScreenState();
}
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                showDescription
                                    ? 'Introducing the Expedition Pro Backpack - the ultimate companion for adventurers, explorers, and outdoor enthusiasts. Designed to tackle the toughest journeys and keep your essentials safe and organized, this backpack is your trusted partner for rugged adventures and everyday use.'
                                     : 'With a spacious main compartment and multiple pockets, the Expedition Pro Backpack offers ample storage space for all your gear and essentials. Stay organized with dedicated compartments for your laptop, water bottle, and smaller items. The adjustable straps and ergonomic design ensure a comfortable fit, even during long treks.'
                                      , style: SafeGoogleFont(
                                  'Poppins',
                                  fontSize: 15 * ffem,
